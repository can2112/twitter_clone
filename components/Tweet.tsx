  ...
  return (
    <div className="flex flex-col space-x-3 border-y p-5 border-gray-100">
               ...
               <div>
                ...
                <p>{tweet.text}</p>
                {tweet.image && 
                  <img src={tweet.image} alt=" tweet image" className="m-5 ml-0 max-h-60 rounded-lg object-cover shadow-sm" />
                }
               </div>
               </div>

               <div className="mt-5 flex justify-between">
                 <div className="flex cursor-pointer items-center space-x-3 text-gray-400"> <ChatAlt2Icon className="h-5 w-5 "/>
                 <p>{comments.length}</p>
                  </div>
                    ...
                    <div >
                       {comments.map((comment)=>(
                         <div key={comment._id} className=" flex space-x-2 relative">
                           ...
                           <img src={comment.profileImg} alt="comment profile image" className=" mt-2 h-7 w-7 object-cover rounded-full"/>
                           <div> 
